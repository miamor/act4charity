...
function ChallengeSelectScreen({ navigation }) {
  ...
  return (
    <DefaultView>
      ...
      <TouchableOpacity onPress={() => navigation.navigate('ChallengeList', { key: 'ChallengeList' })}>
        <Text>Walk</Text>
      </TouchableOpacity>

      <TouchableOpacity onPress={() => navigation.navigate('ChallengeListMap', { key: 'ChallengeListMap' })}>
        <Text>Discovery</Text>
      </TouchableOpacity>
