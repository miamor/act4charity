 ...
 * @constructor
 */
function ChallengeDiscoveryDetailInfoScreen({ route, navigation }) {
  ...
  const onConfirmStart = () => {
    navigation.navigate('ChallengeDiscoveryDetailMap', { key: 'ChallengeDetailMap', challengeDetail: challengeDetail })
  }
      ...
      <View style={{ flex: 1, paddingHorizontal: 10 }}>
        ...
        <View style={{ flex: 0.45, paddingHorizontal: 10, marginTop: 10, alignItems: 'center' }}>
          <View style={{ flex: 1, justifyContent: 'center' }}>
            <Text>Your challenge is to discover the <TextBold>{challengeDetail.location_name}</TextBold></Text>
          </View>
          <View style={{ flex: 1, justifyContent: 'center' }}>
