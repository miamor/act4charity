...
function ChallengeDiscoverDetailStartTeamScreen({ route, navigation }) {
  ...
  const updateTrackState = async (currentLatitude, currentLongitude) => {
    ...
    submitUserLocState(myTrackState) //? share my state to my teammates
  }
  ...
  const onConfirmComplete = () => {
    console.log('onConfirmComplete', onConfirmComplete)
    hideConfirmComplete()
  }
    ...
    <DefaultView>
      ...
      >
        <BottomSheetScrollView contentContainerStyle={{}}>
          ...
          <View style={{ flex: 0.18, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 10, flexDirection: 'row', marginBottom: 10 }}>
            ...
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', alignItems: 'center', flexDirection: 'column' }}>
              <TextBold style={{ fontSize: 28, lineHeight: 40 }}>00:08:00</TextBold>
              <Text style={{ fontSize: 13, lineHeight: 16 }}>Time</Text>
            </View>
          </View>
